...
This file is for transforming the string of WCA scramble's operation (generated by https://www.worldcubeassociation.org/regulations/scrambles/ ) 
to the operations we use in "rubik.h".
Below are the rules we follow:
    X2: *2
    X': *3
    Xw: xX
    Xw2: xXxX
...
// This main function is for multi-line transformation.
